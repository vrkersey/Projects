...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// Method uses recursion to dive down all the direct dependents of a cell name.
        /// After all variables are visited the method backs out adding all cell names to the Linked list.
        /// </summary>
